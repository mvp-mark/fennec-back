...
import com.comunidade.repositories.VacanciesRepository;
...
public class VacanciesService {
	...
	@Autowired
	private VacanciesRepository repo;

	public Vacancies find(Integer id) {
		Optional<Vacancies> obj = repo.findById(id);
		return obj.orElseThrow(() -> new ObjectNotFoundException(
				"Objeto não encontrado! Id: " + id + ", Tipo: " + Client.class.getName()));
	}
	
	public Vacancies insert(Vacancies obj) {
		obj.setId(null);
